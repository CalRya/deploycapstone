            ...
            >
              ...
              <p
                className={`availability ${
                  book.bookAvailability ? "available" : "unavailable"
                }`}
              >
      ...
      {selectedBook && (
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <img
              src={`${BASE_URL}${selectedBook.bookCoverUrl}`}
              alt="Book Cover"
            />
            ...
            <p
              className={`availability ${
                selectedBook.bookAvailability ? "available" : "unavailable"
              }`}
            >
            ...
            {selectedBook.bookPdfUrl && selectedBook.bookPdfUrl.trim() !== "" ? (
              <button
                ...
                onClick={() =>
                  viewPdf(
                    selectedBook.bookPdfUrl.startsWith("http")
                      ? selectedBook.bookPdfUrl
                      : `${BASE_URL}${selectedBook.bookPdfUrl}`
                  )
                }
                style={{
