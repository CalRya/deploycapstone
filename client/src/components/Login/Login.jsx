...
function Login() {
  ...
  const handlePasswordChange = (e) => {
    ...
    if (newPassword && !validatePassword(newPassword)) {
      setPasswordWarning("Password must contain at least 1 uppercase and lowercase letter, 1 special character, and 1 number.");
    } else {
      setPasswordWarning("");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      setErrMsg("Password must contain at least 1 uppercase and lowercase letter, 1 special character, and 1 number.");
      return;
    }
